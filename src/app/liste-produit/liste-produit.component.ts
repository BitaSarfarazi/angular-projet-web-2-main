...
import {DialogCellierComponent} from "../dialog-cellier/dialog-cellier.component";
...
export class ListeProduitComponent implements OnInit {
  ...
  openAddCellierDialog(id_cellier?: any) {
    const dialogRef: any = this.dialog.open(DialogCellierComponent, {
      width: '100%',
      maxWidth: '370px',
      data: {id_cellier}
    }).afterClosed().subscribe(res=>{
    ...
    console.log('openAddCellierDialog', id_cellier);
    if(id_cellier){
      // let instance = dialogRef.componentInstance;
      // console.log('innstance', instance);
      // instance.id_cellier = id_cellier;
    }
  }
    ...
    boireQuantiteBouteilleCellier(data:IProduit){
      console.log('boireQuantiteBouteilleCellier', data);
